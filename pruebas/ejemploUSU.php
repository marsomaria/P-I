...
<body>
    ...
    <?php
        ...
        $sentencia = 'SELECT *, DATE_FORMAT(FNacimiento,"%d/%m/%Y")fechaDMY FROM usuarios';
        ...
        echo '<table><tr>';
        echo '<th>IdUsuario</th><th>Título</th><th>Clave</th><th>Contraseña</th>';
